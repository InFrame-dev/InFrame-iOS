...
class ChoiceGradientButton: UIButton{
    // MARK: - Properties
    ...
    private func configureUI(){
        let view = UIView(frame: CGRect(x: 0, y: 0, width: viewBounds.width/1.3, height: viewBounds.height/19.80))
